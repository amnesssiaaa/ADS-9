...
int main() {
    ...
    for (int n = 3; n <= 7; n++) {
        ...
        long long t1 = std::chrono::duration_cast<std::chrono::microseconds>(end - start).count();
        int fact = 1;
        ...
        long long t2 = std::chrono::duration_cast<std::chrono::microseconds>(end - start).count();
        
        start = std::chrono::high_resolution_clock::now();
        myTree.getPerm2(rnum);
        end = std::chrono::high_resolution_clock::now();
        long long t3 = std::chrono::duration_cast<std::chrono::microseconds>(end - start).count();
